...
public:
    ...
    void setLayer(QtWayland::treeland_dde_shell_surface_v1::layer layer);
...
private:
    ...
    QtWayland::treeland_dde_shell_surface_v1::layer m_layer = QtWayland::treeland_dde_shell_surface_v1::layer_super_overlay;
