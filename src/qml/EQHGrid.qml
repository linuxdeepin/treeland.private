        ...
        Loader {
            ...
            transitions: [
                Transition {
                    from: ""
                    to: "exited"
                    NumberAnimation { properties: "x,y,displayWidth"; duration: 300; easing.type: Easing.OutCubic }
                }
            ]
            x: initialPos.x
            y: initialPos.y
            ...
            Behavior on x { enabled: actv; NumberAnimation { duration: 300; easing.type: Easing.OutCubic }}
            Behavior on y { enabled: actv; NumberAnimation { duration: 300; easing.type: Easing.OutCubic }}
            Behavior on displayWidth {
                enabled: actv
                SequentialAnimation {
                    NumberAnimation { duration: 300; easing.type: Easing.OutCubic }
                    ScriptAction { script: root.enterAnimationFinished = true }
                }
            }
